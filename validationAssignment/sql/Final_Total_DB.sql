...
create table WallDoor(wallID varchar(10) references abstractWall(WallID) check(WallID like 'WC%'),doorID varchar(10) references abstractDoor(doorID) UNIQUE,DisplacementAB integer check(DisplacementAB>0),DisplacementAD integer check(DisplacementAD>0),orientation varchar(4) check(orientation like 'ABCD' OR orientation like 'ABCD' OR orientation like 'ABCD' OR orientation like 'ABCD' OR orientation like 'DCBA' OR orientation like 'DABC' OR orientation like 'CBAD' ),primary key(wallID,doorID));    
...
insert into abstractWall values ('WC101',6100,13600,200,200,200,'RoomRoof'),('WC102',6100,13600,200,200,200,'RoomFloor'),('WC103',13600,3180,200,200,200,'RoomRight'),('WC104',13600,3180,200,200,200,'RoomLeft'),('WC105',3180,6100,200,200,200,'RoomFront'),('WC106',3180,6100,200,200,200,'RoomBack'),('WC201',500,600,150,150,150,'AmpRoof'),('WC202',500,600,150,150,150,'AmpFloor'),('WC203',600,760,150,150,150,'AmpRight'),('WC204',600,760,150,150,150,'AmpLeft'),('WC205',760,500,150,150,150,'AmpFront'),('WC206',760,500,150,150,150,'AmpBack'),('WC301',100,100,0,0,255,'chlkBoxRoof'),('WC302',100,100,0,0,255,'chlkBoxFloor'),('WC303',100,100,0,0,255,'chlkBoxRight'),('WC304',100,100,0,0,255,'chlkBoxLeft'),('WC305',100,100,0,0,255,'chlkBoxFront'),('WC306',100,100,0,0,255,'chlkBoxBack'),('WC401',1500,750,0,0,255,'TableRoof'),('WC402',1500,750,0,0,255,'TableFloor'),('WC403',750,750,0,0,255,'TableRight'),('WC404',750,750,0,0,255,'TableLeft'),('WC405',750,1500,0,0,255,'TableFront'),('WC406',750,1500,0,0,255,'TableBack'),('WC501',540,540,20,20,20,'BlackBoxRoof'),('WC502',550,540,20,20,20,'BlackBoxFloor'),('WC503',540,600,20,20,20,'BlackBoxRight'),('WC504',540,600,20,20,20,'BlackBoxLeft'),('WC505',600,540,150,150,150,'BlackBoxFront'),('WC506',600,540,150,150,150,'BlackBoxBack'),('WC601',50,710,0,0,255,'SmlTableRoof'),('WC602',50,710,0,0,255,'SmlTableFloor'),('WC603',710,120,0,0,255,'SmlTableRight'),('WC604',710,120,0,0,255,'SmlTableLeft'),('WC605',120,50,0,0,255,'SmlTableFront'),('WC606',120,50,0,0,255,'SmlTableBack'),('WC701',50,710,0,0,255,'SmlTableRoof'),('WC702',50,710,0,0,255,'SmlTableFloor'),('WC703',710,590,0,0,255,'SmlTableRight'),('WC704',710,590,0,0,255,'SmlTableLeft'),('WC705',590,50,0,0,255,'SmlTableFront'),('WC706',590,50,0,0,255,'SmlTableBack'),('WNC101',6100,260,200,200,200,'BeamRoof'),('WNC102',6100,260,200,200,200,'BeamFloor'),('WNC103',260,570,200,200,200,'BeamRight'),('WNC104',260,570,200,200,200,'BeamLeft'),('WNC105',570,6100,200,200,200,'BeamFront'),('WNC106',570,6100,200,200,200,'BeamBack'),('WNC201',750,910,218,165,32,'BenchRoof'),('WNC202',750,910,218,165,32,'BenchFloor'),('WNC203',910,750,255,250,205,'BenchRight'),('WNC204',910,750,255,250,205,'BenchLeft'),('WNC205',750,750,255,250,205,'BenchFront'),('WNC206',750,750,255,250,205,'BenchBack'),('WNC301',40,300,211,211,211,'SwitchRoof'),('WNC302',40,300,211,211,211,'SwitchFloor'),('WNC303',300,250,211,211,211,'SwitchRight'),('WNC304',300,250,211,211,211,'SwitchLeft'),('WNC305',250,40,211,211,211,'SwithcFront'),('WNC306',250,40,211,211,211,'SwitchBack'),('WNC401',250,350,5,5,5,'AmplifierRoof'),('WNC402',250,350,5,5,5,'AmplifierFloor'),('WNC403',350,100,5,5,5,'AmplifierRight'),('WNC404',350,100,5,5,5,'AmplifierLeft'),('WNC405',100,250,5,5,5,'AmplifierFront'),('WNC406',100,250,5,5,5,'AmplifierBack'),('WNC501',6100,2000,205,205,205,'StageRoof'),('WNC502',6100,2000,205,205,205,'StageFloor'),('WNC503',2000,300,205,205,205,'StageRight'),('WNC504',2000,300,205,205,205,'StageLeft'),('WNC505',300,6100,205,205,205,'StageFront'),('WNC506',300,6100,205,205,205,'StageBack');
insert into walldoor values ('WC205','d1',200,200,'ABCD'),('WNC105','d2',250,200,'DABC'),('WC105','d3',13590,200,'DABC');
