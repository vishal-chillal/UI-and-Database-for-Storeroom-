...
create table containerObjects (objectID varchar(10) references objects(objectID) UNIQUE check(objectID like 'c%'),containerConcreteTypeId varchar(10) references containerConcreteTypes (containerConcreteTypeId),userLabel varchar(20),userObjectCommentLocal varchar(40));

create table nonContainerObjects (objectID varchar(10) references objects(objectID) unique check(objectID like 'nc%'),nonContainerConcreteTypeId varchar(10) references nonContainerConcreteTypes (nonContainerConcreteTypeId),userLabel varchar(20),userObjectCommentLocal varchar(40) check(objectID like 'nc%'));
...
insert into abstractDoor values ('d1_classRoom',1000,2000,55,60,100),('d2_classRoom',1000,2000,55,60,100),('d3_classRoom',1000,2000,55,60,100),('d4_classRoom',1000,2000,55,60,100),('d5_blackBox',520,520,10,10,10),('d6_ampBox',740,48,50,50,20),('d7',90,90,120,100,30),('d8',1460,730,15,15,20),('d9',480,100,15,15,20),('d10',480,580,15,15,20);
